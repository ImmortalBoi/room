...
import { doc, collection, updateDoc, arrayUnion, arrayRemove, addDoc, Timestamp } from 'firebase/firestore'
...
<template>
  <div v-if="friend" class="flex flex-row justify-between items-center gap-3 my-2 py-2 bg-background-200 px-2 rounded-lg">
    ...
    <div class="flex flex-row gap-2 ">
      <button class="bg-primary-500 p-1 hover:bg-primary-600 rounded-lg" @click="acceptFriendRequest()">
        <svg 
      ...
      <button class="bg-accent-500 p-1 hover:bg-accent-600 rounded-lg" @click="deleteFriendRequest()">
        <svg
