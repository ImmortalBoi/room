...
<template>
  <div
    class="flex w-[596px] max-w-full items-start flex-col gap-0 mt-2 self-start max-md:flex-wrap max-md:mt-10 ml-10"
  >
    <div
      class="text-zinc-800 text-sm tracking-widest bg-secondary-300 grow basis-auto pl-3 pr-2 pt-3 pb-2 rounded-xl self-start max-md:max-w-full max-md:px-5"
    >
